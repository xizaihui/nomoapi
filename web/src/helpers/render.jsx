...
// 基础10色色板 (N ≤ 10) — 钢蓝色系
const baseColors = [
  '#2e3a48', '#3a4d5e', '#4a5c6e', '#6b7f8f', '#8fa0ae',
  '#7a919f', '#9db0bc', '#b3c2cc', '#c2d0d8', '#587082',
];
...
export const modelColorMap = {
  'dall-e': '#587082',
  'dall-e-3': '#4a5c6e',
  'gpt-3.5-turbo': '#8fa0ae',
  'gpt-3.5-turbo-0613': '#7a919f',
  'gpt-3.5-turbo-1106': '#85a0a8',
  'gpt-3.5-turbo-16k': '#9db0bc',
  'gpt-3.5-turbo-16k-0613': '#b3c2cc',
  'gpt-3.5-turbo-instruct': '#c2d0d8',
  'gpt-4': '#3a4d5e',
  'gpt-4-0613': '#4a6575',
  'gpt-4-1106-preview': '#354858',
  'gpt-4-0125-preview': '#2e3a48',
  'gpt-4-turbo-preview': '#2e4050',
  'gpt-4-32k': '#587082',
  'gpt-4-32k-0613': '#4a5c6e',
  'gpt-4-all': '#1c2630',
  'gpt-4-gizmo-*': '#1e3040',
  'gpt-4-vision-preview': '#152530',
  'text-ada-001': '#d0dce4',
  'text-babbage-001': '#ccd8e0',
  'text-curie-001': '#b8b8cc',
  'text-davinci-003': '#9db0bc',
  'text-davinci-edit-001': '#8fa0ae',
  'text-embedding-ada-002': '#e0e0ec',
  'text-embedding-v1': '#eaeaf2',
  'text-moderation-latest': '#c2d0d8',
  'text-moderation-stable': '#b3c2cc',
  'tts-1': '#6e6e80',
  'tts-1-1106': '#75758a',
  'tts-1-hd': '#7a919f',
  'tts-1-hd-1106': '#85a0a8',
  'whisper-1': '#ededf5',
  'claude-3-opus-20240229': '#2e3a48',
  'claude-3-sonnet-20240229': '#4a5c6e',
  'claude-3-haiku-20240307': '#7a919f',
};
