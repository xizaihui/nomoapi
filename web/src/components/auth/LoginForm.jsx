            ...
            <div className='px-2 py-8'>
              <div className='space-y-3'>
                {status.wechat_login && (
                  <Button
                    theme='outline'
                    className='w-full h-12 flex items-center justify-center !rounded-lg border border-border hover:bg-muted transition-colors'
                    type='tertiary'
                    icon={
                      ...
                      {hasUserAgreement && (
                        <>
                          <a
                            ...
                            className='text-foreground underline underline-offset-4 hover:text-foreground/80 mx-1'
                          >
                            {t('用户协议')}
                          </a>
                        </>
            ...
            <div className='px-2 py-8'>
              {status.passkey_login && passkeySupported && (
                <Button
                  theme='outline'
                  type='tertiary'
                  className='w-full h-12 flex items-center justify-center !rounded-lg border border-border hover:bg-muted transition-colors mb-4'
                  icon={<IconKey size='large' />}
                  onClick={handlePasskeyLogin}
                  loading={passkeyLoading}
                >
